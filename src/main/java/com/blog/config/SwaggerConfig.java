...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application", "Sample project", "1.0", "Terms of Service", new Contact("narasimha","sample website", "sample@gmail.com"), "License of APIS","API License URL", Collections.emptyList());
	}
}
